			...
			<div
				...
				<?php for ( $i = 0; $i < 10; $i++ ) : ?>
					<div class="space-y-5 w-full flex flex-col items-center">
						<img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/home7.png"
							alt="" loading="lazy"
		...
		<div class="container">
			<div class="lg:space-y-[30px] space-y-6">
				...
				<div class="max-w-[836px] lg:text-lg text-sm text-[#525256]">
					Trạng thái cân bằng tự nhiên của tế bào là khi môi trường xung quanh và bên
					trong tế bào (gọi là nội
					môi và nội bào) được duy trì ở điều kiện lý tưởng để tế bào sống, trao đổi chất
					và phục hồi. Điều
					này bao gồm pH phù hợp, nồng độ oxy ổn định, ít gốc tự do, đủ dưỡng chất và
					enzyme hoạt động hiệu
					quả.
				</div>
			</div>
			<div
				...
				<?php for ( $i = 0; $i < 4; $i++ ) : ?>
					<div
						...
						<img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/home3.png"
							alt="" loading="lazy" class="absolute inset-0 size-full object-cover">
					</div>
				<?php endfor ?>
			</div>
			<div class="lg:space-y-[30px] space-y-6 text-end">
				...
				<div class="lg:text-lg text-sm lg:space-y-5 space-y-2 text-[#525256]">
					<p>
						Kiềm Thảo Dược Saphia sở hữu độ pH cao vượt trội trong thang kiềm – nằm
						trong nhóm kiềm mạnh
						nhưng
						vẫn an toàn nhờ công thức chiết xuất hoàn toàn từ thảo dược tự nhiên. Đặc
						biệt, sản phẩm được
						nghiên
						cứu để đạt tính kiềm bền vững, tức là duy trì độ pH cao ổn định trong thời
						gian dài mà không bị
						biến
						đổi dưới tác động của môi trường. Đây chính là điểm khác biệt cốt lõi giúp
						sản phẩm có khả năng
						trung hòa axit nhanh chóng, hỗ trợ tái thiết lập môi trường kiềm cho tế bào,
						từ đó nâng cao sức
						đề
						kháng, cải thiện chuyển hóa và thúc đẩy quá trình thải độc một cách tự
						nhiên.
					</p>
					<p>
						Không chỉ đơn thuần là nước uống, Kiềm Thảo Dược Saphia là giải pháp tái tạo
						nội lực – giúp cơ
		...
		<div class="container">
			<div class="lg:space-y-9 space-y-5">
				...
				<div class="lg:text-xl text-base text-content text-center max-w-[760px] mx-auto">
					Dựa trên thông tin bạn cung cấp, chúng tôi đã tạo lộ trình cá nhân hóa giúp cải
					thiện vấn đề sức
	...
	<section class="lg:my-[200px] my-[60px]">
		<div class="container">
			...
			<div class="lg:mt-[50px] mt-10 grid grid-cols-2 grid-rows-3 lg:gap-[30px] gap-2">
				<div
					class="row-span-2 w-full relative rounded-[35px] overflow-hidden lg:min-h-[291px] min-h-[150px]">
					<img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/home3.png"
						alt="" loading="lazy" class="absolute inset-0 size-full object-cover">
				</div>
				<div
					class="row-span-1 lg:text-xl text-[9px] text-[#525256] flex items-center w-full lg:min-h-[291px] min-h-[150px]">
					Bắt nguồn từ kho tàng y học cổ truyền dân tộc, kết hợp với khoa học hiện đại và
					sự thấu hiểu sâu sắc
					về giá trị của thảo dược quê hương, Kiềm Thảo Dược Saphia ra đời như một giải
					pháp đột phá, mang
					trong mình sứ mệnh chăm sóc và bảo vệ sức khỏe con người một cách tự nhiên và
					bền vững. Mỗi giọt
					Kiềm thảo dược là kết tinh của niềm đam mê nghiên cứu, sự trân trọng Mẹ Thiên
					Nhiên và trên hết là
	...
	<section class="lg:my-[200px] my-[60px]">
		<div class="container">
			...
			<div class="lg:mt-20 mt-10">
				...
				<div
					class="mt-[30px] flex flex-wrap items-center justify-center xl:gap-[100px] gap-6">
					<?php for ( $i = 0; $i < 9; $i++ ) : ?>
						<div
							class="xl:min-h-[385px] lg:max-w-[200px] max-w-[100px] flex flex-col <?= $i % 2 == 0 ? '' : 'justify-end' ?> lg:gap-[37px] gap-5">
							<img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/home3.png"
								alt="" loading="lazy"
								class="w-full aspect-square rounded-full overflow-hidden object-cover">
					...
					<ul class="lg:my-16 my-8 lg:pl-5 space-y-4 lg:text-lg text-sm">
						<?php for ( $i = 0; $i < 7; $i++ ) : ?>
							<li class="flex items-center gap-4">
								...
								Trung hoà acid dư thừa <br> Tạo môi trường cân bằng lý tưởng giúp tế bào
								phân chia và sửa
								chữa
							</li>
						<?php endfor ?>
		...
		<div class="container">
			<div class="relative w-full rounded-[35px] bg-[#ECF4FE]">
				<div class="xl:py-[109px] xl:pl-16 p-5 xl:max-w-[664px] md:max-w-[60%]">
					<div
						class="lg:text-[64px] text-4xl leading-[1] tracking-[-0.96px] text-content">
						Kiềm thảo dược Saphia tự hào là doanh nghiệp phát triển bền vững
					</div>
					<div class="mt-5 lg:text-lg text-base text-[#525256]">
						Mỗi sản phẩm của Kiềm Thảo Dược Saphia đều được xây dựng với tầm nhìn dài
						hạn – không chỉ để
						giải quyết vấn đề tức thời, mà để đồng hành lâu dài cùng sức khỏe người tiêu
						dùng. Chính vì vậy,
						chúng tôi lựa chọn đầu tư bài bản vào vùng trồng dược liệu đạt tiêu chuẩn,
						cùng hệ thống nhà máy
						sản xuất chuẩn GMP, nhằm đảm bảo từng giọt sản phẩm đưa đến tay khách hàng
						đều đạt chuẩn cao
						nhất về an toàn, hiệu lực và tính bền vững. Với Kiềm Thảo Dược Saphia, phát
						triển sản phẩm không
						phải để bán nhanh – mà là để sống cùng khách hàng trên hành trình khỏe - đẹp
						- vững bền.
					</div>
				</div>
