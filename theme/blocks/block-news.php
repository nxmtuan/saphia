<section class="lg:mt-[180px] lg:mb-12 my-[60px]">
	<div class="container">
		...
		<div
			class="block_sameheight lg:mt-[100px] mt-10 flex items-stretch gap-[35.585px] block_slider watch_css center_items md:mx-0 -mx-5">
			<?php
			// ACF fields
			...
			if ($posts_list):
				foreach ($posts_list as $p):
					...
					<a href="<?php echo esc_url($permalink); ?>"
						class="sameheight-item block_slider-item group relative md:w-1/2 w-[83%] flex xl:flex-row flex-col xl:items-stretch xl:gap-[47px] md:gap-5 lg:rounded-[30px] rounded-[20px] overflow-hidden bg-[#ECF4FE]">
						<div
							class="1.5xl:w-[333px] xl:w-[260px] w-full aspect-[332/384] lg:rounded-r-[30px] lg:rounded-b-0 rounded-b-[20px] overflow-hidden shrink-0">
						...
						<div class="xl:py-11 xl:pr-11 xl:pl-0 p-6">
							<div class="flex items-center gap-[15px]">
								...
								<span class="text-[#525256] text-lg leading-[32.235px]"><?php echo esc_html($date); ?></span>
							</div>
							<p class="lg:mt-[49px] mt-4 line-clamp-3">
								<span class="block text-content text-[28.206px] leading-[36.265px] tracking-[-0.423px]">
							...
							<p
								class="absolute top-2.5 right-2.5 size-[54px] flex justify-center items-center rounded-full overflow-hidden bg-[#AEBBCE] group-hover:bg-[#757d8a] group-hover:rotate-45 shrink-0 transition-all duration-300">
