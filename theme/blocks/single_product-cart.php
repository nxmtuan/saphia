<section class="lg:my-[200px] my-[60px]" data-components="single_product-cart">
	<div class="container">
		<div
            ...
            <img src="<?php gnws_post_thumbnail_full() ?>" alt="<?php the_title() ?>" class="lg:w-1/2 w-full object-contain">
			...
			<div
				...
				<div
                    ...
                    <?php if( get_field('product_price',get_the_ID()) ): ?>
                        <div class="product-price"><?php the_field('product_price',get_the_ID()); ?></div>
                    <?php endif; ?>
				</div>
				...
				<div
					class="md:px-[25px] px-2 md:py-[19px] py-3 rounded-lg overflow-hidden border border-[#0000001F] text-[#00000070] md:text-sm text-xs flex items-center justify-between">
                        ...
                        <div class="product-price-monthly"><?php the_field('product_price_monthly',get_the_ID()); ?></div>
                    </div>
                    <?php endif; ?>
				<button type="button" data-popup="add-cart"
