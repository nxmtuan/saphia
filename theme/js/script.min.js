...
T\xE2m tr\u1EA1ng hi\u1EC7n t\u1EA1i: ${moodText}`
      ...
      function handlePopup() {
        $2(document).on("click", "[data-popup]", function() {
          $2(".popup").removeClass("active");
          var targetId = $2(this).attr("data-popup");
          $2("#" + targetId).addClass("active");
          $2(".modal-backdrop").addClass("active");
        });
        ...
        $2(document).on("click", ".close-popup", function() {
          $2(this).closest(".popup").removeClass("active");
          $2(".modal-backdrop").removeClass("active");
        });
      }
